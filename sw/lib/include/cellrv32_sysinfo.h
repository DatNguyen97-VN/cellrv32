// #################################################################################################
// # << CELLRV32: cellrv32_sysinfo.h - System Information Memory (SYSINFO) HW Driver >>            #
// # ********************************************************************************************* #
...
#ifndef cellrv32_sysinfo_h
#define cellrv32_sysinfo_h
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  ...
  const uint32_t SOC;         /**< offset 8:  SoC features (#CELLRV32_SYSINFO_SOC_enum) */
  const uint32_t CACHE;       /**< offset 12: cache configuration (#CELLRV32_SYSINFO_CACHE_enum) */
...
/** SYSINFO module hardware access (#cellrv32_sysinfo_t) */
#define CELLRV32_SYSINFO ((cellrv32_sysinfo_t*) (CELLRV32_SYSINFO_BASE))

/** CELLRV32_SYSINFO->SOC (r/-): Implemented processor devices/features */
enum CELLRV32_SYSINFO_SOC_enum {
...
/** CELLRV32_SYSINFO->CACHE (r/-): Cache configuration */
 enum CELLRV32_SYSINFO_CACHE_enum {
