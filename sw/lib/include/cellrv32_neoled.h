// #################################################################################################
// # << CELLRV32: cellrv32_neoled.h - Smart LED Interface (NEOLED) HW Driver >>                    #
// # ********************************************************************************************* #
...
#ifndef cellrv32_neoled_h
#define cellrv32_neoled_h
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  ...
  uint32_t DATA; /**< offset 4: data register (#CELLRV32_NEOLED_CTRL_enum) */
} cellrv32_neoled_t;

/** NEOLED module hardware access (#cellrv32_neoled_t) */
#define CELLRV32_NEOLED ((cellrv32_neoled_t*) (CELLRV32_NEOLED_BASE))

/** NEOLED control register bits */
enum CELLRV32_NEOLED_CTRL_enum {
 ...
 **************************************************************************/
inline void __attribute__ ((always_inline)) cellrv32_neoled_write_nonblocking(uint32_t data) {

  CELLRV32_NEOLED->DATA = data; // send new LED data
}

#endif // cellrv32_neoled_h
