// #################################################################################################
// # << CELLRV32: cellrv32_xip.h - Execute In Place (XIP) Module HW Driver (Header) >>             #
// # ********************************************************************************************* #
...
#ifndef cellrv32_xip_h
#define cellrv32_xip_h
...
typedef volatile struct __attribute__((packed,aligned(4))) {
  uint32_t CTRL;           /**< offset  0: control register (#CELLRV32_XIP_CTRL_enum) */
...
/** XIP module hardware access (#cellrv32_xip_t) */
#define CELLRV32_XIP ((cellrv32_xip_t*) (CELLRV32_XIP_BASE))

/** XIP control/data register bits */
enum CELLRV32_XIP_CTRL_enum {
